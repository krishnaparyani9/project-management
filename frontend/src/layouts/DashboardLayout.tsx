...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-0)] text-[var(--text-body)] flex flex-col md:flex-row">
      <aside className="w-full md:w-[280px] border-b border-slate-700 bg-[var(--bg-2)] p-4 md:sticky md:top-0 md:h-screen md:border-b-0 md:border-r md:border-slate-700 md:p-7 flex-shrink-0">
        <div className="flex h-full flex-col">
          <header className="mb-8 rounded-xl border border-slate-700 bg-[var(--bg-1)] p-4">
          ...
          <div className="mt-6 space-y-4 md:mt-auto">
            <div className="rounded-xl border border-slate-700 bg-[var(--bg-1)] p-3">
      ...
      <main className="flex-1 p-4 md:p-8 bg-[var(--bg-0)] min-h-screen">
